...
export default function BuilderPage() {
  ...
  const generatePipeline = () => {
    if (
      ...
      toast.warning(
        'Please fill in pipeline name, select engine, and add at least one step.'
      )
      return
    }
  ...
  .map((step, index) => {
    ...
    if (conditionalSteps && !isAllProjects) {
      const conditions = targetProjects
        .map(
          projectId =>
            `needs.detect-changes.outputs.${projectId}-changed == 'true'`
        )
        .join(' || ')
      condition = `
      if: ${conditions}`
...
${
  steps
    ...
    .map(
      (secret: string) =>
        `        ${secret} = credentials('${secret.toLowerCase()}')`
    )
...
`
  ...
  const renderStepConfig = () => {
    if (!selectedStep) {
      return (
        <div className="flex flex-col items-center justify-center h-64 text-muted-foreground overflow-auto">
    ...
    return (
      <div className="space-y-6 overflow-auto pb-4">
        ...
        <div className="p-4 border rounded-lg bg-muted/50 overflow-auto">
          <Label className="text-sm font-medium">Target Projects</Label>
          <p className="text-xs text-muted-foreground mb-3">
            Select which projects this step should run for
          </p>
                ...
                {projects.map(project => (
                  <div key={project.id} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      checked={
                        selectedStep.targetProjects?.includes(project.id) ||
                        false
                      }
                      onCheckedChange={checked => {
                        ...
                        const newTargets = checked
                          ? [
                              ...currentTargets.filter(t => t !== 'all'),
                              project.id,
                            ]
                          : currentTargets.filter(t => t !== project.id)
                        updateStepConfig(selectedStep.id, {
                          targetProjects: newTargets,
                        })
                      }}
                    />
                    <Label
        ...
        {conditionalSteps && (
          <div className="p-4 border rounded-lg bg-muted/50">
            ...
            <p className="text-xs text-muted-foreground mb-3">
              Run this step only when specific conditions are met
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="only-if-changed"
                  checked={
                    selectedStep.config.conditions?.onlyIfChanged || false
                  }
                  onCheckedChange={checked =>
                    updateStepConfig(selectedStep.id, {
                      conditions: {
              ...
              {selectedStep.config.conditions?.onlyIfChanged && (
                <div>
                  ...
                  <Textarea
                    ...
                    value={
                      selectedStep.config.conditions?.paths?.join('\n') || ''
                    }
                    onChange={e =>
                      updateStepConfig(selectedStep.id, {
                        conditions: {
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    One path per line. Leave empty to auto-detect based on
                    target projects.
                  </p>
                </div>
              )}
          ...
          <>
            <div className="px-2">
              ...
              <Select
                ...
                onValueChange={value =>
                  updateStepConfig(selectedStep.id, { workspaceMode: value })
                }
              >
                <SelectTrigger>
            ...
            <div className="px-2">
              <Label htmlFor="workspace-command">
                Workspace Command Template
              </Label>
              <Input
                ...
                onChange={e =>
                  updateStepConfig(selectedStep.id, {
                    workspaceCommand: e.target.value,
                  })
                }
              />
              <p className="text-xs text-muted-foreground mt-1">
                Template for running commands in specific workspaces. Project
            ...
            <div className="px-2">
              ...
              <Select
                ...
                onValueChange={value =>
                  updateStepConfig(selectedStep.id, { nodeVersion: value })
                }
              >
            ...
            {matrixBuild && (
              <div className="p-3 border rounded bg-blue-50">
                ...
                <p className="text-xs text-blue-600 mt-1">
                  This step will run in parallel for each selected project using
                  matrix strategy.
                </p>
              </div>
            )}
          ...
          <>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  updateStepConfig(selectedStep.id, { testFramework: value })
                }
              >
                <SelectTrigger>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={checked =>
                  updateStepConfig(selectedStep.id, { coverage: checked })
                }
              />
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  updateStepConfig(selectedStep.id, { timeout: e.target.value })
                }
              />
            </div>
          </>
          ...
          <>
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  updateStepConfig(selectedStep.id, { environment: value })
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  updateStepConfig(selectedStep.id, { target: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={e =>
                  updateStepConfig(selectedStep.id, {
                    preDeployScript: e.target.value,
                  })
                }
                rows={3}
              />
          ...
          <>
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  updateStepConfig(selectedStep.id, { provider: value })
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  updateStepConfig(selectedStep.id, { region: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  updateStepConfig(selectedStep.id, { service: value })
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  updateStepConfig(selectedStep.id, { autoScaling: value })
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <>
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  updateStepConfig(selectedStep.id, { envFile: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  updateStepConfig(selectedStep.id, { secretSource: value })
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <>
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  updateStepConfig(selectedStep.id, { language: value })
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={e =>
                  updateStepConfig(selectedStep.id, { script: e.target.value })
                }
    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="grid grid-cols-12 h-full">
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">
                              ...
                              {stepType.type === 'deploy' &&
                                'Deploy to target environment'}
                              {stepType.type === 'cloud' &&
                                'Deploy to cloud providers'}
                              {stepType.type === 'secrets' &&
                                'Manage environment variables'}
                              {stepType.type === 'custom' &&
                                'Run custom scripts'}
                            </div>
                          </div>
                        </Button>
          ...
          <div className="col-span-5 p-4 overflow-auto">
            <Card className="h-full overflow-auto">
              <CardHeader>
                ...
                <CardDescription>
                  Configure your pipeline workflow
                </CardDescription>
              </CardHeader>
              <CardContent>
                {steps.length === 0 ? (
          ...
          <div className="col-span-4 border-l bg-muted/30 flex flex-col overflow-auto">
